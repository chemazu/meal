...
import tom from "../../images/tomorrow.jpg";
import tod from "../../images/chicken-rice-2.jpg";

import yes from "../../images/yesterday.jpg";
import MealItem from "../../component/MealItem";

export default function Dashboard() {
  let user = { name: "Chukwuemeka" };
  let orders = [{ one: 1 }];
  function formatDate(date: any, offset = 0) {
      ...
      <section className="meal-action">
        ...
        <div className="weekly-meal">
          ...
          <div className="single-meal-item">
            ...
            <div className="meal-image-holder">
              <img src={yes} className="meal-image" alt="meal" />
              <div className="meal-text">
                {/* <p>1800kcals</p>
          ...
          <div className="single-meal-item">
            ...
            <div className="meal-image-holder">
              <img src={tod} className="meal-image" alt="meal" />
              <div className="meal-text">
                {/* <p>1800kcals</p>
                <p>P:250 ,F:250,C: 250</p>
                <p>...</p> */}
          ...
          <div className="single-meal-item">
            ...
            <p>{formatDate(Date.now(), 1)}</p>
            <div className="meal-image-holder">
              <img src={tom} className="meal-image" alt="meal" />
              <div className="meal-text">
                {/* <p>1800kcals</p>
                <p>P:250 ,F:250,C: 250</p>
                <p>...</p> */}

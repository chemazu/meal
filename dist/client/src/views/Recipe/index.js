...
const timer_svg_1 = __importDefault(require("../../images/timer.svg"));
const goat_meat_pepper_soup_jpeg_1 = __importDefault(require("../../images/goat-meat-pepper-soup.jpeg"));
function Recipe() {
    // let nutrionalvalues = {
    //   calories: 570,
    //   fats: 23,
    ...
    const singleMeal = {
        ...
        prepTime: "45 minutes",
        description: "Uncover the delightful world of African comfort cuisine with Goat Meat Pepper Soup, an enticing blend of flavors that packs a protein punch while being supportive of both muscle growth and fat loss.",
        nutrionalvalues: {
            calories: 570,
            fats: 23,
            carbohydrates: 20,
    ...
    let { nutrionalvalues, title, description, tags, ingredients, preparation, prepTime, } = singleMeal;
    return (<>
      <Navbar_1.default />
      ...
      <section className="recipe-page">
        <div className="recipe-title">
          <div className="time">
            <img src={timer_svg_1.default} alt="timer"/>
            <p>{prepTime}</p>
          </div>
          <h2>{title}</h2>
          <p className="sub-heading">{description}</p>{" "}
          <div className="recipe-img">
            <img src={goat_meat_pepper_soup_jpeg_1.default}/>
          </div>
